...
load("feeding/Spp_traits_habs/Species_presence/MASTER.bin10000_allhab_tresh10.Rdata")
dim(master)
master$PAGENAME <- as.character(master$PAGENAME)
rownames(master) <- master$PAGENAME

# *Loading species properties 
load('10k/froggy_outputs/networkpropEUROPE_10HAB.Rdata')   # Same as Europe (as in the paper, but with basal decomposition into two categories)
...
save(networkprops, file = '../BioticData/10k/Network_properties_Thr10.Rdata')
#